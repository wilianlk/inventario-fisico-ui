                            ...
                            <Table className="w-full table-fixed">
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="w-[110px] whitespace-nowrap text-[11px] px-2 text-right">Costo Unitario</TableHead>

                                        <TableHead className="w-[95px] whitespace-nowrap text-[11px] px-2">Grupo C1</TableHead>
                                        <TableHead className="w-[65px] whitespace-nowrap text-[11px] px-2 text-right">Conteo 1</TableHead>

                                        <TableHead className="w-[95px] whitespace-nowrap text-[11px] px-2">Grupo C2</TableHead>
                                        <TableHead className="w-[65px] whitespace-nowrap text-[11px] px-2 text-right">Conteo 2</TableHead>

                                        <TableHead className="w-[85px] whitespace-nowrap text-[11px] px-2">Reconteos</TableHead>

                                        <TableHead className="w-[95px] whitespace-nowrap text-[11px] px-2">Grupo C3</TableHead>
                                        <TableHead className="w-[65px] whitespace-nowrap text-[11px] px-2 text-right">Conteo 3</TableHead>

                                        <TableHead className="w-[100px] whitespace-nowrap text-[11px] px-2 text-right">Captura Final</TableHead>
                                        <TableHead className="w-[85px] whitespace-nowrap text-[11px] px-2 text-right">Congelada</TableHead>
                                    </TableRow>
                                </TableHeader>
                                ...
                                <TableBody>
                                    {rows.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={17} className="text-xs text-slate-500 py-6 text-center">
